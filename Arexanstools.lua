...
task.spawn(function()
    ...
    local RekamanTabContent = Instance.new("ScrollingFrame")
    ...
    RekamanTabContent.CanvasSize = UDim2.new(0, 0, 0, 0)
    RekamanTabContent.ScrollBarThickness = 10
    RekamanTabContent.VerticalScrollBarInset = Enum.ScrollBarInset.Always
    RekamanTabContent.ScrollingDirection = Enum.ScrollingDirection.Y
    ...
    setupCanvasSize(RekamanListLayout, RekamanTabContent)
    ...
    local function initializeEmoteGUI()
        ...
        EmoteMainFrame.Size = UDim2.new(0, 160, 0, 180) -- Ukuran diperkecil
        ...
        UIGridLayout.CellSize = UDim2.new(0, 32, 0, 44) -- Ukuran sel diperkecil
        ...
        task.spawn(function()
            local success, result = pcall(function() return HttpService:JSONDecode(game:HttpGet("https://raw.githubusercontent.com/AREXANS/qrsixx/refs/heads/main/emote.json?token=GHSAT0AAAAAADLEASNR4QW24CTSZGFFWIZY2GY4HWQ")) end)
        ...
        pcall(function()
            ...
            task.spawn(function()
                ...
                local success, animData = pcall(function()
                    return HttpService:JSONDecode(game:HttpGet("https://raw.githubusercontent.com/AREXANS/qrsixx/refs/heads/main/animation.json?token=GHSAT0AAAAAADLEASNRQA4QYMXRWQYTHRWI2GY4F4Q"))
                end)
            ...
            playbackConnection = RunService.RenderStepped:Connect(function(dt)
                ...
                if isPaused then
                    if not wasPaused then 
                        ...
                        -- [[ PERBAIKAN: Hentikan animasi saat jeda, terlepas dari bypass ]]
                ...
                -- [[ PERUBAHAN: Deteksi penyelesaian pemutaran ]]
                if elapsedTime >= recordingDuration then
                    if playbackConnection then playbackConnection:Disconnect(); playbackConnection = nil end
                    if customRunningSound and customRunningSound.Parent then customRunningSound:Destroy() end
                ...
                if not playbackMovers.alignPos then return end
                ...
                pcall(function()
                    ...
                    if customRunningSound then
                        if (currentState == "Enum.HumanoidStateType.Running" or currentState == "Enum.HumanoidStateType.RunningNoPhysics") and not customRunningSound.IsPlaying then
                            customRunningSound:Play()
                        elseif currentState ~= "Enum.HumanoidStateType.Running" and currentState ~= "Enum.HumanoidStateType.RunningNoPhysics" and customRunningSound.IsPlaying then
...
local RECORDING_EXPORT_FILE = RECORDING_FOLDER .. "/" .. exportName .. ".json"
        ...
        local bypassAnimToggle, bypassAnimSwitch = createToggle(RekamanTabContent, "Bypass Animasi", isAnimationBypassEnabled, function(v)
        ...
        recordingsListFrame.LayoutOrder = 6
